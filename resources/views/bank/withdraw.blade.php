...
@section('content')
    <section style="background-image: url('{{ asset('build/assets/bg-gray.jpg') }}')" class="bg-cover min-h-screen">
        <main class="max-w-5xl mx-auto flex flex-col">
            ...
            <h1 class="text-2xl font-bold text-center my-15">Access your funds whenever you need them.
                Make a withdrawal and experience banking where your money is always within reach.</h1>
            ...
            <div class="bg-secondary text-primary shadow-lg flex justify-between rounded-2xl p-5 border-black border-2 my-2">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <form action="{{ route('bank.withdraw.update', $account->id) }}" method="POST">
                        ...
                        <button
                            class="inline-block bg-green-500 text-light font-bold p-2 rounded-2xl transform duration-500 hover:scale-105 shadow-md border-2">Withdraw</button>
                        @error('amount')
